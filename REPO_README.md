...
```
ai-developer-playbook/
├── README.md                          ← Full AI Developer Playbook Guide
...
│   └── playbook-guide.md              ← Playbook reference
...
5. **Full Guide**: For in-depth instructions and examples, see [`README.md`](README.md).
