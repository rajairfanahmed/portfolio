...
| Motion | Framer Motion 13.4 (dock mounted in job `02`; page `AnimatePresence` is job `03`) | Physics-based animations, layout morphing, route transitions |
